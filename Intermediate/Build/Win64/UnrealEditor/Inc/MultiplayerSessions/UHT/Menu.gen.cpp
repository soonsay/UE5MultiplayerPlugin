...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMenu_Statics::NewProp_HostButton_MetaData[] = {
		{ "BindWidget", "" },
		{ "Comment", "// If binding widgets with the meta specifier, the UButton name MUST match the button name\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Menu.h" },
		{ "ToolTip", "If binding widgets with the meta specifier, the UButton name MUST match the button name" },
	};
#endif
	...
	UMenu::~UMenu() {}
	struct Z_CompiledInDeferFile_FID_Users_miles_Documents_Unreal_Projects_UE5_MPShooter_MPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_miles_Documents_Unreal_Projects_UE5_MPShooter_MPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 3389869816U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_miles_Documents_Unreal_Projects_UE5_MPShooter_MPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_1037775794(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_Users_miles_Documents_Unreal_Projects_UE5_MPShooter_MPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_miles_Documents_Unreal_Projects_UE5_MPShooter_MPShooter_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
